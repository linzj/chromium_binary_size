...
PACKAGE_INFO.update({
    ...
    'uc_android_webview_shell': chrome.PackageInfo(
        'com.uc.webkit.shell',
        'com.uc.webkit.shell.BrowserActivity',
        '/data/local/tmp/android-webview-command-line',
        None),
    #endif
    #if UC_BUILD_CTS_TEST
    'UCCTS': chrome.PackageInfo(
        'com.UCMobile.cts',
        'com.UCMobile.cts.BrowserActivity',
        '/data/local/tmp/android-webview-command-line',
        None),
    #endif
